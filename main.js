...
var hasCustomer = transactions.filter(function(transaction) {
    return transaction.customer;
})

var customers = hasCustomer.map(function(transaction) {
  return transaction.customer;
})
...
*/
var itemPrices = transactions[0].items.map( function(item){
  return item.price;
});
